# Identify the streets on tr0751-038



- **Date:** on 
- **Sheet:** `tr0751-038-100dpi.png` (100 dpi; every pixel coordinate below is
  measured against this render)
- **Alignment:** `tr0751-038-alignment.json` — control points mapping scan pixels
  to lat/lng, already fitted by a human
- **Coverage:** the polygon in `tr0751-038.js`, in scan pixels — the ground this
  document testifies about
- **Modern streets:** `tr0751-038-streets.json` — where every modern street inside
...
1. **Geometry only, never names.** A corridor labelled X on the plat
   ...
   **not** assume the plat's numbered streets are the modern numbered streets
   ...
   match from where the lines are, using `tr0751-038-streets.json`, and only then
...
**Edit `tr0751-038.js` directly.** Replace its empty `rows: []` with the rows
below. Do not put them in a new file: a separate file has to be merged in by
hand, and the review tool only ever reads `tr0751-038.js`. Leave the rest of that
...
(The same list is in `tr0751-038-streets.json` under `nameCandidates`.)
...
### 4th Place (runs straight into 4th Street, Mateo Street)

- `third-street` — 3rd Street: attested on 4th Place by another sheet; attested on 4th Street, which 4th Place runs straight into; ink seen: “THIRD” [mr013-087-p1]
- `fourth-street` — 4th Street: attested on 4th Street, which 4th Place runs straight into; ink seen: “4TH ST”, “4TH ST.”, “CALLE 4a”, “FOURTH STREET”, “Fourth St”, “Fourth Street” [12685, mr001-489, mr005-005, mr012-026, mr030-009-p4, mr030-009-p5, mr053-068, mr053-069, mr053-071]
- `huber-st` — Huber Street: attested on 4th Street, which 4th Place runs straight into; ink seen: “HUBER ST.”, “Huber St” [mr013-087-p1, mr030-009-p4]
- `spruce` — Spruce Street: attested on Mateo Street, which 4th Place runs straight into; ink seen: “Spruce St” [mr011-042]

### 4th Street (runs straight into 4th Place)

- `fourth-street` — 4th Street: attested on 4th Street by another sheet; carries the street's present name; ink seen: “4TH ST”, “4TH ST.”, “CALLE 4a”, “FOURTH STREET”, “Fourth St”, “Fourth Street” [12685, mr001-489, mr005-005, mr012-026, mr030-009-p4, mr030-009-p5, mr053-068, mr053-069, mr053-071]
- `huber-st` — Huber Street: attested on 4th Street by another sheet; ink seen: “HUBER ST.”, “Huber St” [mr013-087-p1, mr030-009-p4]
- `third-street` — 3rd Street: attested on 4th Street by another sheet; attested on 4th Place, which 4th Street runs straight into; ink seen: “THIRD” [mr013-087-p1]

### 5th Street

- `fifth-street` — 5th Street: attested on 5th Street by another sheet; carries the street's present name; ink seen: “5TH ST”, “5TH ST.”, “CALLE 5a”, “FIFTH STREET”, “Fifth St”, “Fifth St.”, “Fifth St. (Extension)” [mr001-462, mr003-166-p2, mr005-307-b, mr030-009-p3, mr030-009-p4, mr039-069, mr053-068, mr053-071]
- `poplar-st` — Poplar Street: attested on 5th Street by another sheet; ink seen: “Poplar St” [mr030-009-p2]
- `sixth-street` — 6th Street: attested on 5th Street by another sheet; ink seen: “SIXTH ST.” [mr084-053]

### Hewitt Street

- `hewitt` — Hewitt Street: attested on Hewitt Street by another sheet; carries the street's present name; ink seen: “HEWITT ST”, “HEWITT STREET”, “Hewitt STREET.” [mr002-092-p1, mr002-092-p2, mr003-060-p1, mr003-060-p2, mr013-087-p1, tr1339-069-p3]
...
`to` must be names from that street's `crossings` in `tr0751-038-streets.json`,
