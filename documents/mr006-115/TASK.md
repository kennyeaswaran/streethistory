# Identify the streets on mr006-115



- **Date:** on 
- **Sheet:** `mr006-115-100dpi.png` (100 dpi; every pixel coordinate below is
  measured against this render)
- **Alignment:** `mr006-115-alignment.json` — control points mapping scan pixels
  to lat/lng, already fitted by a human
- **Coverage:** the polygon in `mr006-115.js`, in scan pixels — the ground this
  document testifies about
- **Modern streets:** `mr006-115-streets.json` — where every modern street inside
...
Modern streets inside the coverage polygon (15):
...
1. **Geometry only, never names.** A corridor labelled X on the plat
   ...
   **not** assume the plat's numbered streets are the modern numbered streets
   ...
   match from where the lines are, using `mr006-115-streets.json`, and only then
...
**Edit `mr006-115.js` directly.** Replace its empty `rows: []` with the rows
below. Do not put them in a new file: a separate file has to be merged in by
hand, and the review tool only ever reads `mr006-115.js`. Leave the rest of that
...
(The same list is in `mr006-115-streets.json` under `nameCandidates`.)
...
### 1st Street (runs straight into Beverly Boulevard)
...
- `diamond-street` — Diamond Street: attested on Beverly Boulevard, which 1st Street runs straight into; ink seen: “Diamond Street” [mr006-138]

### 2nd Street (runs straight into Glendale Boulevard, Lucas Avenue)

- `second-street` — 2nd Street: attested on 2nd Street by another sheet; carries the street's present name; ink seen: “2D ST”, “2ND ST.”, “2ND STREET”, “CALLE 2a”, “SECOND STREET”, “Second Street”, “W. 2ND ST.”, “W. 2ND STREET” [12685, mr001-489, mr005-307-a, mr053-069, mr053-071, tr0015-166a-p1, tr0015-166a-p2, tr0885-030-p2, tr0926-086-p2, tr0938-051-p3, tr1339-069-p3]
...
- `lucas-avenue` — Lucas Avenue: attested on Lucas Avenue, which 2nd Street runs straight into; ink seen: “LUCAS AVENUE” [tr0015-166a-p2]

### Beaudry Avenue

- `beaudry-st` — Beaudry Street: carries the street's present name

### Bixel Street

- `bixel` — Bixel Street: attested on Bixel Street by another sheet; carries the street's present name; ink seen: “BIXEL ST” [mr066-035]

### Boylston Street (runs straight into Huntley Drive)

- `figueroa-gov` — Figueroa Street: attested on Boylston Street by another sheet; ink seen: “FIGUEROA ST.” [mr066-035]
- `boylston` — Boylston Street: carries the street's present name

### Diamond Street

- `diamond-street` — Diamond Street: carries the street's present name
...
- `farmer` — Farmer Street: attested on Emerald Drive by another sheet; ink seen: “FARMER ST.” [tr0015-166a-p2]

### Emerald Street

- no entity attested here yet — leave `name` out

### Glendale Boulevard (runs straight into 2nd Street, Lucas Avenue)

- `lake-avenue` — Lake Avenue: attested on Glendale Boulevard by another sheet; ink seen: “Lake Avenue” [mr006-138]
- `second-street` — 2nd Street: attested on 2nd Street, which Glendale Boulevard runs straight into; ink seen: “2D ST”, “2ND ST.”, “2ND STREET”, “CALLE 2a”, “SECOND STREET”, “Second Street”, “W. 2ND ST.”, “W. 2ND STREET” [12685, mr001-489, mr005-307-a, mr053-069, mr053-071, tr0015-166a-p1, tr0015-166a-p2, tr0885-030-p2, tr0926-086-p2, tr0938-051-p3, tr1339-069-p3]
...
- `lucas-avenue` — Lucas Avenue: attested on Lucas Avenue, which Glendale Boulevard runs straight into; ink seen: “LUCAS AVENUE” [tr0015-166a-p2]
...
- `figueroa-gov` — Figueroa Street: attested on Boylston Street, which Huntley Drive runs straight into; ink seen: “FIGUEROA ST.” [mr066-035]

### Lucas Avenue (runs straight into 2nd Street, Glendale Boulevard)

- `lucas-avenue` — Lucas Avenue: attested on Lucas Avenue by another sheet; carries the street's present name; ink seen: “LUCAS AVENUE” [tr0015-166a-p2]
- `second-street` — 2nd Street: attested on 2nd Street, which Lucas Avenue runs straight into; ink seen: “2D ST”, “2ND ST.”, “2ND STREET”, “CALLE 2a”, “SECOND STREET”, “Second Street”, “W. 2ND ST.”, “W. 2ND STREET” [12685, mr001-489, mr005-307-a, mr053-069, mr053-071, tr0015-166a-p1, tr0015-166a-p2, tr0885-030-p2, tr0926-086-p2, tr0938-051-p3, tr1339-069-p3]
...
- `third-street` — 3rd Street: attested on Miramar Street by another sheet; attested on 3rd Street, which Miramar Street runs straight into; ink seen: “3RD ST”, “3RD ST.”, “3RD STREET”, “CALLE 3a”, “THIRD ST.”, “THIRD STREET”, “Third St”, “Third Street”, “W. 3RD STREET” [12685, mr001-489, mr030-009-p5, mr053-069, mr053-071, mr066-035, tr0015-166a-p1, tr0015-166a-p2, tr0926-086-p2]
...
- `arnold` — Arnold Street: attested on 3rd Street, which Miramar Street runs straight into; ink seen: “ARNOLD ST.” [mr066-035]
...
`to` must be names from that street's `crossings` in `mr006-115-streets.json`,
