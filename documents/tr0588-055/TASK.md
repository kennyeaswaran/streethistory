# Identify the streets on tr0588-055



- **Date:** on 
- **Sheet:** `tr0588-055-100dpi.png` (100 dpi; every pixel coordinate below is
  measured against this render)
- **Alignment:** `tr0588-055-alignment.json` — control points mapping scan pixels
  to lat/lng, already fitted by a human
- **Coverage:** the polygon in `tr0588-055.js`, in scan pixels — the ground this
  document testifies about
- **Modern streets:** `tr0588-055-streets.json` — where every modern street inside
...
1. **Geometry only, never names.** A corridor labelled X on the plat
   ...
   **not** assume the plat's numbered streets are the modern numbered streets
   ...
   match from where the lines are, using `tr0588-055-streets.json`, and only then
...
**Edit `tr0588-055.js` directly.** Replace its empty `rows: []` with the rows
below. Do not put them in a new file: a separate file has to be merged in by
hand, and the review tool only ever reads `tr0588-055.js`. Leave the rest of that
...
(The same list is in `tr0588-055-streets.json` under `nameCandidates`.)
...
- `fifth-street` — 5th Street: attested on 5th Street by another sheet; carries the street's present name; ink seen: “5TH ST”, “5TH ST.”, “CALLE 5a”, “FIFTH STREET”, “Fifth St”, “Fifth St.”, “Fifth St. (Extension)” [mr001-462, mr003-166-p2, mr005-307-b, mr030-009-p3, mr030-009-p4, mr039-069, mr053-068, mr053-071, tr0751-038]
- `poplar-st` — Poplar Street: attested on 5th Street by another sheet; ink seen: “Poplar St”, “Poplar St.” [mr012-042, mr030-009-p2]
- `sixth-street` — 6th Street: attested on 6th Street, which 5th Street runs straight into; ink seen: “6TH ST”, “6TH ST.”, “6TH STREET”, “6th St”, “CALLE 6a”, “SIXTH ST.”, “SIXTH STR.”, “SIXTH STREET”, “Sixth St”, “Sixth St Extension.”, “Sixth St.”, “proposed line of Sixth Street.” [mr001-462, mr003-016, mr003-166-p1, mr003-569, mr006-033, mr011-042, mr030-009-p1, mr030-009-p2, mr030-009-p3, mr053-068, mr053-071, mr084-053, tr0009-075, tr0009-100a, tr0012-101, tr0023-066, tr0159-032-p2, tr0273-017, tr0319-001-p1]
...
`to` must be names from that street's `crossings` in `tr0588-055-streets.json`,
