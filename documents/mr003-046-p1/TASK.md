# Identify the streets on mr003-046-p1



- **Date:** on 
- **Sheet:** `mr003-046-p1-100dpi.png` (100 dpi; every pixel coordinate below is
  measured against this render)
- **Alignment:** `mr003-046-p1-alignment.json` — control points mapping scan pixels
  to lat/lng, already fitted by a human
- **Coverage:** the polygon in `mr003-046-p1.js`, in scan pixels — the ground this
  document testifies about
- **Modern streets:** `mr003-046-p1-streets.json` — where every modern street inside
...
1. **Geometry only, never names.** A corridor labelled X on the plat
   ...
   **not** assume the plat's numbered streets are the modern numbered streets
   ...
   match from where the lines are, using `mr003-046-p1-streets.json`, and only then
...
**Edit `mr003-046-p1.js` directly.** Replace its empty `rows: []` with the rows
below. Do not put them in a new file: a separate file has to be merged in by
hand, and the review tool only ever reads `mr003-046-p1.js`. Leave the rest of that
...
(The same list is in `mr003-046-p1-streets.json` under `nameCandidates`.)
...
### 3rd Street (runs straight into 4th Street, Miramar Street)

- `third-street` — 3rd Street: attested on 3rd Street by another sheet; attested on 4th Street, which 3rd Street runs straight into; attested on Miramar Street, which 3rd Street runs straight into; carries the street's present name; ink seen: “3RD ST”, “3RD ST.”, “3RD STREET”, “CALLE 3a”, “THIRD”, “THIRD ST.”, “THIRD STREET”, “Third St”, “Third Street”, “W. 3RD STREET” [12685, mr001-489, mr013-087-p1, mr030-009-p5, mr053-069, mr053-071, mr066-035, tr0015-166a-p1, tr0015-166a-p2, tr0926-086-p2]
...
- `arnold` — Arnold Street: attested on 3rd Street by another sheet; ink seen: “ARNOLD ST.” [mr066-035]
...
- `fourth-street` — 4th Street: attested on 4th Street, which 3rd Street runs straight into; ink seen: “4TH ST”, “4TH ST.”, “4TH STREET”, “CALLE 4a”, “FOURTH STREET”, “Fourth St”, “Fourth Street” [12685, mr001-489, mr005-005, mr012-026, mr030-009-p4, mr030-009-p5, mr053-068, mr053-069, mr053-071, tr0012-186, tr0751-038]
...
### 4th Street (runs straight into 3rd Street)

- `fourth-street` — 4th Street: attested on 4th Street by another sheet; carries the street's present name; ink seen: “4TH ST”, “4TH ST.”, “4TH STREET”, “CALLE 4a”, “FOURTH STREET”, “Fourth St”, “Fourth Street” [12685, mr001-489, mr005-005, mr012-026, mr030-009-p4, mr030-009-p5, mr053-068, mr053-069, mr053-071, tr0012-186, tr0751-038]
...
- `third-street` — 3rd Street: attested on 4th Street by another sheet; attested on 3rd Street, which 4th Street runs straight into; ink seen: “3RD ST”, “3RD ST.”, “3RD STREET”, “CALLE 3a”, “THIRD”, “THIRD STREET”, “Third St”, “Third Street” [12685, mr001-489, mr013-087-p1, mr030-009-p5, mr053-069, mr053-071, tr0926-086-p2]
...
- `arnold` — Arnold Street: attested on 3rd Street, which 4th Street runs straight into; ink seen: “ARNOLD ST.” [mr066-035]
...
`to` must be names from that street's `crossings` in `mr003-046-p1-streets.json`,
