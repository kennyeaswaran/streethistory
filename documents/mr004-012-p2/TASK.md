# Identify the streets on mr004-012-p2



- **Date:** on 
- **Sheet:** `mr004-012-p2-100dpi.png` (100 dpi; every pixel coordinate below is
  measured against this render)
- **Alignment:** `mr004-012-p2-alignment.json` — control points mapping scan pixels
  to lat/lng, already fitted by a human
- **Coverage:** the polygon in `mr004-012-p2.js`, in scan pixels — the ground this
  document testifies about
- **Modern streets:** `mr004-012-p2-streets.json` — where every modern street inside
...
1. **Geometry only, never names.** A corridor labelled X on the plat
   ...
   **not** assume the plat's numbered streets are the modern numbered streets
   ...
   match from where the lines are, using `mr004-012-p2-streets.json`, and only then
...
**Edit `mr004-012-p2.js` directly.** Replace its empty `rows: []` with the rows
below. Do not put them in a new file: a separate file has to be merged in by
hand, and the review tool only ever reads `mr004-012-p2.js`. Leave the rest of that
...
(The same list is in `mr004-012-p2-streets.json` under `nameCandidates`.)
...
- `alameda-st` — Alameda Street: attested on Alameda Street by another sheet; carries the street's present name; ink seen: “ALAMEDA ST”, “ALAMEDA ST.”, “ALAMEDA STREET”, “Alameda STREET.”, “Alameda St”, “Alameda St.” [mr002-092-p1, mr002-092-p2, mr003-060-p1, mr003-060-p2, mr012-042, mr013-087-p1, mr013-091, mr030-009-p1, mr030-009-p2, mr030-009-p4, mr030-009-p5, tr0005-056a, tr0009-075, tr0012-101, tr0145-062, tr0926-086-p2]
...
- `banning-street` — Banning Street: attested on Banning Street by another sheet; carries the street's present name; ink seen: “Banning Street” [tr0145-062]

### Center Street (runs straight into Ramirez Street, Santa Fe Avenue)

- `tulip` — Tulip Street: attested on Santa Fe Avenue, which Center Street runs straight into; ink seen: “Tulip St”, “Tulip St.” [mr011-042, mr015-052]
- `santa-fe-ave` — Santa Fe Avenue: attested on Santa Fe Avenue, which Center Street runs straight into; ink seen: “SANTA FE AVE.”, “SANTA FE AVENUE”, “Santa Fe Avenue”, “Santa Fe Avenue.” [mr018-025, tr0012-186, tr0159-021-p2, tr0319-001-p1]

### Commercial Street (runs straight into Aliso Street)

- `commercial-street` — Commercial Street: carries the street's present name
...
- `garey` — Garey Street: attested on Garey Street by another sheet; carries the street's present name; ink seen: “GAREY STREET” [mr003-060-p2]
- `messer-street` — Messer Street: attested on Garey Street by another sheet; ink seen: “Messer STREET.” [mr002-092-p2]

### Hewitt Street

- `carolina-arts-district` — Carolina Street: attested on Hewitt Street by another sheet; ink seen: “CAROLINA ST.”, “Carolina St.” [mr012-042, tr0012-101]
- `hewitt` — Hewitt Street: attested on Hewitt Street by another sheet; carries the street's present name; ink seen: “HEWITT ST”, “HEWITT STREET”, “Hewitt STREET.” [mr002-092-p1, mr002-092-p2, mr003-060-p1, mr003-060-p2, mr013-087-p1, tr0751-038, tr1339-069-p3]
...
- `turner-street` — Turner Street: attested on Jackson Street by another sheet; ink seen: “Turner Street” [tr0145-062]

### Keller Street (runs straight into Ramirez Street)

- no entity attested here yet — leave `name` out

### Ramirez Street (runs straight into Center Street, Keller Street)

- no entity attested here yet — leave `name` out

### Rose Street

- `rose-street` — Rose Street: attested on Rose Street by another sheet; carries the street's present name; ink seen: “ROSE STREET”, “Rose STREET.” [mr002-092-p1, mr002-092-p2, tr1339-069-p3]

### Santa Ana Freeway

- no entity attested here yet — leave `name` out

### Santa Fe Avenue (runs straight into Center Street)

- `tulip` — Tulip Street: attested on Santa Fe Avenue by another sheet; ink seen: “Tulip St”, “Tulip St.” [mr011-042, mr015-052]
- `santa-fe-ave` — Santa Fe Avenue: attested on Santa Fe Avenue by another sheet; carries the street's present name; ink seen: “SANTA FE AVE.”, “SANTA FE AVENUE”, “Santa Fe Avenue”, “Santa Fe Avenue.” [mr018-025, tr0012-186, tr0159-021-p2, tr0319-001-p1]
...
- `market-st` — Market Street: attested on Temple Street by another sheet; ink seen: “Market St” [tr0020-196b]

### Vignes Street

- `vignes-street` — Vignes Street: attested on Vignes Street by another sheet; carries the street's present name; ink seen: “VIGNES STREET” [tr0145-062]
...
`to` must be names from that street's `crossings` in `mr004-012-p2-streets.json`,
