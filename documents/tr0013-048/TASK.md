# Identify the streets on tr0013-048

Map of the Ulm Tract

- **Date:** on 1907-10-04
- **Sheet:** `tr0013-048-100dpi.png` (100 dpi; every pixel coordinate below is
  measured against this render)
- **Alignment:** `tr0013-048-alignment.json` — control points mapping scan pixels
  to lat/lng, already fitted by a human
- **Coverage:** the polygon in `tr0013-048.js`, in scan pixels — the ground this
  document testifies about
- **Modern streets:** `tr0013-048-streets.json` — where every modern street inside
...
1. **Geometry only, never names.** A corridor labelled X on the plat
   ...
   **not** assume the plat's numbered streets are the modern numbered streets
   ...
   match from where the lines are, using `tr0013-048-streets.json`, and only then
...
**Edit `tr0013-048.js` directly.** Replace its empty `rows: []` with the rows
below. Do not put them in a new file: a separate file has to be merged in by
hand, and the review tool only ever reads `tr0013-048.js`. Leave the rest of that
...
(The same list is in `tr0013-048-streets.json` under `nameCandidates`.)
...
- `eighth-street` — 8th Street: attested on 8th Street by another sheet; carries the street's present name; ink seen: “8TH ST”, “8TH STREET”, “8th St.”, “8th Street”, “CALLE 8a”, “EAST EIGHTH STREET”, “EIGHTH ST”, “EIGHTH ST.”, “EIGHTH STREET”, “Eighth St”, “Eighth St.”, “Eighth Street”, “new 8th Street” [11824, mr003-569, mr011-008, mr018-092, mr021-046, mr026-060, mr029-026, mr029-085, mr053-065, mr053-068, mr054-051, mr055-086, mr070-051, pm017-045, tr0005-156a, tr0007-085, tr0013-048, tr0105-001-p2, tr0141-011]

### Crocker Street

- `crocker-street` — Crocker Street: attested on Crocker Street by another sheet; carries the street's present name; ink seen: “CROCKER ST”, “CROCKER STREET” [mr066-064, tr0013-048]
- `stanford-ave` — Stanford Avenue: attested on Crocker Street by another sheet; ink seen: “Stanford Ave” [mr030-009-p2, mr030-009-p3, mr030-009-p4, mr030-009-p5]
- `clark-ave` — Clark Avenue: attested on Crocker Street by another sheet; ink seen: “Clark Ave.” [mr053-065]
...
- `towne-ave` — Towne Avenue: attested on Towne Avenue by another sheet; carries the street's present name; ink seen: “TOWNE AVE”, “TOWNE AVE.”, “TOWNE AVENUE”, “Towne Ave”, “Towne Ave.” [mr029-085, mr030-009-p2, mr030-009-p3, mr030-009-p4, mr030-009-p5, mr066-064, mr070-084, tr0005-156a, tr0013-048]
...
`to` must be names from that street's `crossings` in `tr0013-048-streets.json`,
