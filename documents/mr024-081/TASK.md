# Identify the streets on mr024-081



- **Date:** on 
- **Sheet:** `mr024-081-100dpi.png` (100 dpi; every pixel coordinate below is
  measured against this render)
- **Alignment:** `mr024-081-alignment.json` — control points mapping scan pixels
  to lat/lng, already fitted by a human
- **Coverage:** the polygon in `mr024-081.js`, in scan pixels — the ground this
  document testifies about
- **Modern streets:** `mr024-081-streets.json` — where every modern street inside
...
Modern streets inside the coverage polygon (8):
...
1. **Geometry only, never names.** A corridor labelled X on the plat
   ...
   **not** assume the plat's numbered streets are the modern numbered streets
   ...
   match from where the lines are, using `mr024-081-streets.json`, and only then
...
**Edit `mr024-081.js` directly.** Replace its empty `rows: []` with the rows
below. Do not put them in a new file: a separate file has to be merged in by
hand, and the review tool only ever reads `mr024-081.js`. Leave the rest of that
...
(The same list is in `mr024-081-streets.json` under `nameCandidates`.)
...
- `first-street` — 1st Street: attested on 1st Street by another sheet; carries the street's present name; ink seen: “1ST ST”, “1ST STREET”, “1st ST”, “1st STREET”, “CALLE 1a”, “FIRST ST”, “FIRST ST.”, “FIRST STREET”, “FIRST STREET.”, “First Street” [12685, mr001-489, mr002-092-p1, mr003-060-p1, mr003-146-p1, mr004-012-p2, mr005-307-a, mr006-308, mr010-008, mr053-069, mr053-071, tr0012-023a, tr0043-032, tr0221-009-p2, tr0417-049-p2, tr0713-093-p2, tr0856-050-p2, tr0885-030-p2, tr1339-069-p3]
- `diamond-street` — Diamond Street: attested on 1st Street by another sheet; ink seen: “DIAMOND STREET”, “Diamond”, “Diamond St.” [mr005-069, mr006-115, mr007-026-p2]
...
### Merrick Street (runs straight into Traction Avenue)

- `traction-avenue` — Traction Avenue: attested on Traction Avenue, which Merrick Street runs straight into; ink seen: “TRACTION AVENUE” [tr0926-086-p2]
- `second-street` — 2nd Street: attested on Traction Avenue, which Merrick Street runs straight into; ink seen: “SECOND” [mr013-087-p1]

### Santa Fe Avenue (runs straight into Center Street, Mateo Street)
...
- `center-street` — Center Street: attested on Center Street, which Santa Fe Avenue runs straight into; ink seen: “CENTER ST.”, “CENTER STREET” [mr004-012-p2, tr0201-001-p2]
- `mateo` — Mateo Street: attested on Mateo Street, which Santa Fe Avenue runs straight into; ink seen: “MATEO ST.”, “MATEO STREET”, “Mateo St.”, “Mateo Street” [mr015-052, mr018-025, mr053-083, tr0005-056a, tr0012-101, tr0012-186, tr0020-053b, tr0023-066, tr0159-032-p2]
- `spruce` — Spruce Street: attested on Mateo Street, which Santa Fe Avenue runs straight into; ink seen: “Spruce St” [mr011-042]

### Traction Avenue (runs straight into Merrick Street)

- `traction-avenue` — Traction Avenue: attested on Traction Avenue by another sheet; carries the street's present name; ink seen: “TRACTION AVENUE” [tr0926-086-p2]
- `second-street` — 2nd Street: attested on Traction Avenue by another sheet; ink seen: “SECOND” [mr013-087-p1]

### Vignes Street

- `vignes-street` — Vignes Street: attested on Vignes Street by another sheet; carries the street's present name; ink seen: “VIGNES ST.”, “VIGNES STREET”, “Vignes”, “Vignes Street” [mr002-526-p1, mr002-526-p2, mr004-012-p2, tr0145-062, tr0201-001-p2]
...
`to` must be names from that street's `crossings` in `mr024-081-streets.json`,
