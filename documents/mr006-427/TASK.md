# Identify the streets on mr006-427



- **Date:** on 
- **Sheet:** `mr006-427-100dpi.png` (100 dpi; every pixel coordinate below is
  measured against this render)
- **Alignment:** `mr006-427-alignment.json` — control points mapping scan pixels
  to lat/lng, already fitted by a human
- **Coverage:** the polygon in `mr006-427.js`, in scan pixels — the ground this
  document testifies about
- **Modern streets:** `mr006-427-streets.json` — where every modern street inside
...
1. **Geometry only, never names.** A corridor labelled X on the plat
   ...
   **not** assume the plat's numbered streets are the modern numbered streets
   ...
   match from where the lines are, using `mr006-427-streets.json`, and only then
...
**Edit `mr006-427.js` directly.** Replace its empty `rows: []` with the rows
below. Do not put them in a new file: a separate file has to be merged in by
hand, and the review tool only ever reads `mr006-427.js`. Leave the rest of that
...
(The same list is in `mr006-427-streets.json` under `nameCandidates`.)
...
### 3rd Street (runs straight into 4th Street)

- `third-street` — 3rd Street: attested on 3rd Street by another sheet; attested on 4th Street, which 3rd Street runs straight into; carries the street's present name; ink seen: “3RD ST”, “3RD ST.”, “3RD STREET”, “3d Street”, “CALLE 3a”, “THIRD”, “THIRD ST.”, “THIRD STREET”, “Third St”, “Third Street” [12685, mr001-489, mr013-087-p1, mr016-059, mr030-009-p5, mr053-069, mr053-071, tr0001-052, tr0006-150a, tr0926-086-p2]
...
- `arnold` — Arnold Street: attested on 3rd Street, which 4th Street runs straight into; ink seen: “ARNOLD ST.” [mr003-046-p1, mr066-035]
...
### 6th Street (runs straight into 5th Street)
...
- `ward-st` — Ward Street: attested on 6th Street by another sheet; attested on 5th Street, which 6th Street runs straight into; ink seen: “WARD ST.” [mr003-046-p2]
- `fifth-street` — 5th Street: attested on 5th Street, which 6th Street runs straight into; ink seen: “5TH ST”, “5TH ST.”, “CALLE 5a”, “FIFTH ST.”, “FIFTH STREET”, “Fifth St”, “Fifth St.”, “Fifth St. (Extension)” [mr001-462, mr003-046-p2, mr003-166-p2, mr005-307-b, mr030-009-p3, mr030-009-p4, mr039-069, mr053-068, mr053-071, tr0010-175a, tr0588-055, tr0751-038]
...
- `lafayette-bixel` — Lafayette Avenue: attested on Bixel Street by another sheet; ink seen: “LAFAYETTE ST.”, “Lafayette Av.” [mr003-046-p1, mr003-046-p2, mr006-115]
...
`to` must be names from that street's `crossings` in `mr006-427-streets.json`,
