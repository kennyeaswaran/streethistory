# Identify the streets on tr0005-065



- **Date:** on 
- **Sheet:** `tr0005-065-100dpi.png` (100 dpi; every pixel coordinate below is
  measured against this render)
- **Alignment:** `tr0005-065-alignment.json` — control points mapping scan pixels
  to lat/lng, already fitted by a human
- **Coverage:** the polygon in `tr0005-065.js`, in scan pixels — the ground this
  document testifies about
- **Modern streets:** `tr0005-065-streets.json` — where every modern street inside
...
1. **Geometry only, never names.** A corridor labelled X on the plat
   ...
   **not** assume the plat's numbered streets are the modern numbered streets
   ...
   match from where the lines are, using `tr0005-065-streets.json`, and only then
...
**Edit `tr0005-065.js` directly.** Replace its empty `rows: []` with the rows
below. Do not put them in a new file: a separate file has to be merged in by
hand, and the review tool only ever reads `tr0005-065.js`. Leave the rest of that
...
(The same list is in `tr0005-065-streets.json` under `nameCandidates`.)
...
- `eleventh-street` — 11th Street: attested on 10th Street by another sheet; ink seen: “11th St.”, “Eleventh St.” [mr029-085, mr053-065]
- `tenth-street` — 10th Street: carries the street's present name

### 9th Street (runs straight into Olympic Boulevard)

- `ninth-street` — 9th Street: attested on 9th Street by another sheet; attested on Olympic Boulevard, which 9th Street runs straight into; carries the street's present name; ink seen: “9TH STREET”, “9th St.”, “9th Street”, “CALLE 9a”, “East 9th Street”, “NINTH STREET”, “Ninth St.”, “Ninth Street”, “Ninth Street Extension” [11824, mr011-008, mr016-027, mr026-059, mr029-085, mr037-087, mr053-063, mr053-065, mr053-067, mr053-068, mr055-086, tr0105-001-p2, tr0141-011]
- `moran-s-lane` — Moran's Lane: attested on 9th Street by another sheet; ink seen: “Moran's Lane” [11824]
- `tenth-street` — 10th Street: attested on Olympic Boulevard, which 9th Street runs straight into; ink seen: “TENTH STREET”, “Tenth Street” [mr003-032, mr003-033, mr016-027, mr053-063]

### Stanford Avenue

- `ruth-ave` — Ruth Avenue: attested on Stanford Avenue by another sheet; ink seen: “RUTH AVE.”, “RUTH AVENUE”, “Ruth Ave” [mr030-009-p2, mr030-009-p3, mr030-009-p4, mr030-009-p5, mr066-064, mr070-084, tr0005-156a, tr0007-085]
- `stanford-ave` — Stanford Avenue: attested on Stanford Avenue by another sheet; carries the street's present name; ink seen: “STANFORD AVE.”, “STANFORD AVENUE”, “Stanford Ave”, “Stanford Ave.” [mr029-085, mr055-086, pm017-045, tr0005-156a, tr0007-085]
...
`to` must be names from that street's `crossings` in `tr0005-065-streets.json`,
