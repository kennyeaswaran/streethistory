module.exports = {
  ...
  alignment: {
    ...
    dpi: 100,
    points: [
      { px: [0, 0], ll: [34.054681, -118.240817], note: "map-tool corner (0,0)" },
      { px: [1117, 0], ll: [34.054585, -118.238939], note: "map-tool corner (1117,0)" },
      { px: [0, 1842], ll: [34.052097, -118.241007], note: "map-tool corner (0,1842)" }
    ]
  },
