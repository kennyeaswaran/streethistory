# Identify the streets on tr0012-088a



- **Date:** on 
- **Sheet:** `tr0012-088a-100dpi.png` (100 dpi; every pixel coordinate below is
  measured against this render)
- **Alignment:** `tr0012-088a-alignment.json` — control points mapping scan pixels
  to lat/lng, already fitted by a human
- **Coverage:** the polygon in `tr0012-088a.js`, in scan pixels — the ground this
  document testifies about
- **Modern streets:** `tr0012-088a-streets.json` — where every modern street inside
...
1. **Geometry only, never names.** A corridor labelled X on the plat
   ...
   **not** assume the plat's numbered streets are the modern numbered streets
   ...
   match from where the lines are, using `tr0012-088a-streets.json`, and only then
...
**Edit `tr0012-088a.js` directly.** Replace its empty `rows: []` with the rows
below. Do not put them in a new file: a separate file has to be merged in by
hand, and the review tool only ever reads `tr0012-088a.js`. Leave the rest of that
...
(The same list is in `tr0012-088a-streets.json` under `nameCandidates`.)
...
### 8th Street (runs straight into Green Avenue)
...
### Green Avenue (runs straight into 8th Street)

- `eighth-street` — 8th Street: attested on 8th Street, which Green Avenue runs straight into; ink seen: “8TH ST”, “8TH STREET”, “8th St”, “8th St.”, “8th Street”, “CALLE 8a”, “EAST EIGHTH STREET”, “EIGHTH ST”, “EIGHTH ST.”, “EIGHTH STREET”, “Eighth St”, “Eighth St.”, “Eighth Street”, “new 8th Street” [11824, mr003-569, mr011-008, mr018-092, mr021-046, mr021-087, mr026-060, mr029-026, mr029-085, mr053-065, mr053-068, mr054-051, mr055-086, mr060-088, mr070-051, pm017-045, tr0001-037, tr0005-042b, tr0005-156a, tr0007-085, tr0013-048, tr0105-001-p2, tr0141-011]
- `lincoln-place` — Lincoln Place: attested on 8th Street, which Green Avenue runs straight into; ink seen: “Lincoln Place” [mr006-193]

### James M Wood Boulevard

- `ninth-street` — 9th Street: attested on James M Wood Boulevard by another sheet; ink seen: “NINTH ST”, “NINTH STREET”, “Ninth Street” [mr003-569, mr005-405, mr006-193, tr0001-037, tr0001-038a]
...
- `valencia-street-poindexter` — Valencia Street: carries the street's present name
...
`to` must be names from that street's `crossings` in `tr0012-088a-streets.json`,
