# Identify the streets on tr0157-045-p2



- **Date:** on 
- **Sheet:** `tr0157-045-p2-100dpi.png` (100 dpi; every pixel coordinate below is
  measured against this render)
- **Alignment:** `tr0157-045-p2-alignment.json` — control points mapping scan pixels
  to lat/lng, already fitted by a human
- **Coverage:** the polygon in `tr0157-045-p2.js`, in scan pixels — the ground this
  document testifies about
- **Modern streets:** `tr0157-045-p2-streets.json` — where every modern street inside
...
Modern streets inside the coverage polygon (13):
...
1. **Geometry only, never names.** A corridor labelled X on the plat
   ...
   **not** assume the plat's numbered streets are the modern numbered streets
   ...
   match from where the lines are, using `tr0157-045-p2-streets.json`, and only then
...
**Edit `tr0157-045-p2.js` directly.** Replace its empty `rows: []` with the rows
below. Do not put them in a new file: a separate file has to be merged in by
hand, and the review tool only ever reads `tr0157-045-p2.js`. Leave the rest of that
...
(The same list is in `tr0157-045-p2-streets.json` under `nameCandidates`.)
...
- `alameda-st` — Alameda Street: attested on Alameda Street by another sheet; carries the street's present name; ink seen: “ALAMEDA ST”, “ALAMEDA ST.”, “ALAMEDA STREET”, “Alameda STREET.”, “Alameda St”, “Alameda St.”, “Alameda Strt.” [mr002-092-p1, mr002-092-p2, mr002-526-p1, mr003-060-p1, mr003-060-p2, mr004-012-p2, mr012-042, mr013-087-p1, mr013-091, mr030-009-p1, mr030-009-p2, mr030-009-p4, mr030-009-p5, oldplaza1873, tr0005-056a, tr0009-075, tr0012-101, tr0014-033, tr0014-111b, tr0014-200a, tr0021-144a, tr0100-025, tr0110-048, tr0145-062, tr0926-086-p2]

### Aliso Street (runs straight into Arcadia Street, Commercial Street, I-10 Metro ExpressLanes)

- `sainsevain-street` — Sainsevain Street: attested on Commercial Street, which Aliso Street runs straight into; ink seen: “SAINSEVAIN STREET”, “Sainsevain Street” [mr002-526-p1, mr004-012-p2]
- `commercial-street` — Commercial Street: attested on Commercial Street, which Aliso Street runs straight into; ink seen: “COMMERCIAL ST.”, “COMMERCIAL STREET” [tr0018-025a, tr0018-029a, tr0201-001-p2]

### Arcadia Street (runs straight into Aliso Street, I-10 Metro ExpressLanes)

- no entity attested here yet — leave `name` out

### Avila Street (runs straight into Cesar E Chavez Avenue, Clara Street)

- `short-street-chavez` — Short Street: attested on Cesar E Chavez Avenue, which Avila Street runs straight into; ink seen: “C CORTA”, “Calle Corta”, “SHORT ST”, “Short St” [mr003-240, mr053-073, oldplaza1873]
- `marchessault-street` — Marchessault Street: attested on Cesar E Chavez Avenue, which Avila Street runs straight into; ink seen: “MARCHESSAULT STREET” [oldplaza1873]
- `macy-street` — Macy Street: attested on Cesar E Chavez Avenue, which Avila Street runs straight into; ink seen: “MACY ST.”, “MACY STREET” [oldplaza1873, tr0006-051a]
- `canal-and-reservoir-st` — Canal and Reservoir Street: attested on Cesar E Chavez Avenue, which Avila Street runs straight into; ink seen: “Canal and Reservoir Street” [mr007-026-p1]

### Cesar E Chavez Avenue (runs straight into Avila Street, Clara Street)

- `short-street-chavez` — Short Street: attested on Cesar E Chavez Avenue by another sheet; ink seen: “C CORTA”, “Calle Corta”, “SHORT ST”, “Short St” [mr003-240, mr053-073, oldplaza1873]
- `marchessault-street` — Marchessault Street: attested on Cesar E Chavez Avenue by another sheet; ink seen: “MARCHESSAULT STREET” [oldplaza1873]
- `macy-street` — Macy Street: attested on Cesar E Chavez Avenue by another sheet; ink seen: “MACY ST.”, “MACY STREET” [oldplaza1873, tr0006-051a]
- `canal-and-reservoir-st` — Canal and Reservoir Street: attested on Cesar E Chavez Avenue by another sheet; ink seen: “Canal and Reservoir Street” [mr007-026-p1]
- `cesar-e-chavez-avenue` — Cesar E Chavez Avenue: carries the street's present name

### Clara Street (runs straight into Avila Street, Cesar E Chavez Avenue)

- `short-street-chavez` — Short Street: attested on Cesar E Chavez Avenue, which Clara Street runs straight into; ink seen: “C CORTA”, “Calle Corta”, “SHORT ST”, “Short St” [mr003-240, mr053-073, oldplaza1873]
- `marchessault-street` — Marchessault Street: attested on Cesar E Chavez Avenue, which Clara Street runs straight into; ink seen: “MARCHESSAULT STREET” [oldplaza1873]
- `macy-street` — Macy Street: attested on Cesar E Chavez Avenue, which Clara Street runs straight into; ink seen: “MACY ST.”, “MACY STREET” [oldplaza1873, tr0006-051a]
- `canal-and-reservoir-st` — Canal and Reservoir Street: attested on Cesar E Chavez Avenue, which Clara Street runs straight into; ink seen: “Canal and Reservoir Street” [mr007-026-p1]

### I-10 Metro ExpressLanes (runs straight into Aliso Street, Arcadia Street)
...
- `calle-de-los-negros` — Calle De Los Negros: attested on Los Angeles Street by another sheet; ink seen: “CALLE de los NEGROS”, “Calle de los Negros” [oldplaza1873]
...
- `wine-street-plaza` — Wine Street: attested on Olvera Street by another sheet; ink seen: “WINE STREET” [oldplaza1873]
...
- `vignes-street` — Vignes Street: attested on Vignes Street by another sheet; carries the street's present name; ink seen: “VIGNES ST.”, “VIGNES STREET”, “Vignes”, “Vignes Street” [mr002-526-p1, mr002-526-p2, mr004-012-p2, tr0116-085-p1, tr0145-062, tr0201-001-p2]
...
`to` must be names from that street's `crossings` in `tr0157-045-p2-streets.json`,
