// tools/prune-sources.js — one-off cleanup of redundant `sources` in data/names.js.
...
//      one, §4.4a) that LETTERS THIS NAME — tools/generate.js cites the earliest
...
// comes from utilities/names-tool.html, so there is one implementation of it, and every
...
// --- the pass ---------------------------------------------------------------
const file = path.join(PROJECT, "data/names.js");
