// Streetymology coverage report. Run: node tools/coverage-report.js
...
const fs = require("fs");
const dataSrc = fs.readFileSync(PROJECT + "/generated/streets-data.js", "utf8");
...
const { NEIGHBORHOODS } = require(PROJECT + "/data/site-config.js");

let geom;
try {
  const gSrc = fs.readFileSync(PROJECT + "/data/streets-geometry.js", "utf8");
...
const { normalizeName: normalize } = require(PROJECT + "/data/site-config.js");
