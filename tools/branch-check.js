// tools/branch-check.js — finds two roadways that run side by side under ONE name.
// Run: node tools/branch-check.js            (after replacing data/streets-geometry.js)
//
...
// its own street by OSM way id in WAY_STREET_KEYS (data/site-config.js). This
...
const { normalizeName, WAY_STREET_KEYS } = require(path.join(PROJECT, "data/site-config.js"));
