// tools/diff-street.js — the acceptance-test harness (MODEL-SPEC.md §11).
// Usage: node tools/diff-street.js "3rd Street" [--full]
// Structurally diffs one street's entry between legacy/streets-data-2026-08.js
// and generated/streets-data.js (the generated file), field by field, segment by segment.
...
function loadData(file) {
  const src = fs.readFileSync(path.join(PROJECT, file), "utf8");
  return new Function(src + "; return STREET_DATA;")();
}
const legacy = loadData("legacy/streets-data-2026-08.js");
const gen = loadData("generated/streets-data.js");
