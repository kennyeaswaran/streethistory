...
// Usage: node tools/intersect.js "Central Avenue" "2nd Street"

const PROJECT = require("path").join(__dirname, ".."); // the project root: this script lives one folder down
const fs = require("fs");
const g = new Function(fs.readFileSync(PROJECT + "/data/streets-geometry.js", "utf8") + "; return STREET_GEOMETRY;")();
const geom = g.data || g;
const { normalizeName: normalize } = require(PROJECT + "/data/site-config.js"); // directionals + NAME_ALIASES

const [a, b] = process.argv.slice(2);
if (!a || !b) { console.error('Usage: node tools/intersect.js "Street A" "Street B"'); process.exit(1); }
