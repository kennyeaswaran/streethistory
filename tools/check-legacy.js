// tools/check-legacy.js — every legacy segment is SUBSUMED by the generated output,
...
//
// Run: node tools/check-legacy.js [--verbose] [--street "3rd Street"]
// Reads: legacy/streets-data-2026-08.js (the hand-authored map, frozen),
//        generated/streets-data.js (the generated file), data/streets-geometry.js,
...
const { normalizeName } = require(path.join(PROJECT, "data/site-config.js"));

const load = f => new Function(fs.readFileSync(path.join(PROJECT, f), "utf8") + "; return STREET_DATA;")();
const LEGACY = load("legacy/streets-data-2026-08.js");
const GEN = load("generated/streets-data.js");
const ACCEPTED = fs.existsSync(path.join(PROJECT, "legacy/accepted-differences.js"))
  ? require(path.join(PROJECT, "legacy/accepted-differences.js")) : [];
