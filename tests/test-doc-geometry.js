// tests/test-doc-geometry.js — headless tests for the geometry core (MAP-TOOL-SPEC §6).
// Run: node tests/test-doc-geometry.js
...
{
  // Ground truth from tools/intersect.js: 3rd Street x Bixel Street.
