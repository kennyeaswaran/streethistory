# Identify the streets on mr066-035-100dpi

Map of the Compromise Subdivision of the Washington Tract

- **Date:** on 1894-03
- **Sheet:** `mr066-035-100dpi-100dpi.png` (100 dpi; every pixel coordinate below is
  measured against this render)
- **Alignment:** `mr066-035-100dpi-alignment.json` — control points mapping scan pixels
  to lat/lng, already fitted by a human
- **Coverage:** the polygon in `mr066-035-100dpi.js`, in scan pixels — the ground this
...
Rows to paste into `mr066-035-100dpi.js`, in this shape — all of them
