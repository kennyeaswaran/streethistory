...
//
// These three constants used to live in `generated/streets-data.js`, which has been
...
//   • `<script src="data/site-config.js">` — index.html, utilities/map-tool.html,
//     utilities/names-tool.html
//   • `require("./site-config.js")` — tools/generate.js, documents/osm.js,
//     tools/check-model.js, tools/check-data.js, tools/intersect.js, tools/coverage-report.js
...
// gap in 2nd Street. Every consumer now calls this one — tools/generate.js,
// documents/osm.js, tools/check-model.js, utilities/map-tool.html, tools/intersect.js,
// tools/coverage-report.js and the map itself — so a name means the same thing in
...
// West Bank Plaza at The Broad"): that is EXCLUDE_NAMES in tools/generate.js.
const NAME_ALIASES = {
...
const CATEGORIES = [
  ...
  // member of their household. tools/check-model.js requires one of them on every
  ...
  // LEGACY ONLY. The hand-authored generated/streets-data.js (archived as
  ...
  // tools/check-model.js, tools/check-data.js, utilities/names-tool.html and tools/generate.js's
